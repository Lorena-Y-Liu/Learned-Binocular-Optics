"""
Ring-coded DOE (Diffractive Optical Element) camera module for left camera.
...
class MixedCamera(BaseCamera):
    """
    Left camera with ring-coded diffractive optical element.
    ...
    a .mat file (does/Ring/Ring_L.mat) and is not optimizable.
    ...
    def height(self) -> torch.Tensor:
        ...
        When use_pretrained_doe=True: loads from does/Ring/Ring_L.mat
